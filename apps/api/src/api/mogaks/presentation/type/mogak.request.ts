...
export const moderatPatchRequestSchema = moderatRequestSchema.partial().refine(
  (value) => value.title !== undefined || value.color !== undefined,
);
...
export const mogakPatchRequestSchema = z
  ...
  .strict()
  .refine((value) => value.title !== undefined || value.color !== undefined || value.category !== undefined);
