...
import { PostController } from '../../../src/posts/presentation/controller/post.controller';
...
describe('게시글 HTTP 계약', () => {
  ...
  it('기존 API 보안 정책과 같은 액세스 토큰 가드를 댓글 목록에 적용한다', () => {
    expect(Reflect.getMetadata(GUARDS_METADATA, PostController.prototype.listComments)).toContain(
      AccessTokenGuard,
    );
  });
