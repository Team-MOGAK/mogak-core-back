import { isCommentAuthor } from '../../../../src/posts/domain/policy/postComment.policy';
import {
  validateCommentContents,
  validatePostContents,
} from '../../../../src/posts/domain/policy/postContents.policy';
...
describe('게시글 도메인 규칙', () => {
  ...
  it('댓글 작성자만 댓글을 소유한다', () => {
    expect(isCommentAuthor(7, 7)).toBe(true);
    expect(isCommentAuthor(7, 8)).toBe(false);
  });
});
