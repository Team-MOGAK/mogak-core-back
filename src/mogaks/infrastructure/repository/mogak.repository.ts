...
import type { MogakRepositoryPort } from '../../application/port/mogak.repository.port';
import type {
  MogakCategoryResult,
  MogakResult,
  ModaratResult,
} from '../../application/type/mogak.result';
import type {
  CreatedJogakResult,
  ExecutionResult,
  OccurrenceScheduleResult,
  OwnedJogakResult,
} from '../../application/type/jogak.result';
import { MogakPersistenceException } from '../exception/mogakPersistence.exception';
import { JogakExecutionStatus } from '../../domain/vo/jogakExecution.vo';
import { JogakScheduleType, JogakScheduleWeekdayName } from '../../domain/vo/jogakSchedule.vo';
